...
namespace LCDSArtGallery.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class HomeController : Controller
    {
        ...
        {
            IEnumerable<Product> productList = _unitOfWork.Product.GetAll(includeProperties: "ProductType");
        ...
        public IActionResult Details(int id)
        {
            var productFromDb = _unitOfWork.Product.
                        GetFirstOrDefault(u => u.Id == id, includeProperties: "ProductType");
        ...
        /*        HttpContext.Session.SetInt32(SD.ssShoppingCart, count);*/
            ...
            {
                var productFromDb = _unitOfWork.Product.
                        GetFirstOrDefault(u => u.Id == CartObject.ProductId, includeProperties: "ProductType");
                ShoppingCart cartObj = new ShoppingCart()
                {
                    Product = productFromDb,
                    ProductId = productFromDb.Id
